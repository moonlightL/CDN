...
(function() {
    let APP = {
        ...
        plugins: {
            APlayer: {
                css: "/theme/Grace/source/js/APlayer/APlayer.min.css",
                js: "/theme/Grace/source/js/APlayer/APlayer.min.js"
            },
            bootstrap: {
              js: "/theme/Grace/source/css/bootstrap/js/bootstrap.min.js"
            },
            highlight: {
                js: "/theme/Grace/source/js/highlightjs/highlight.pack.js",
            },
            lazyLoad: {
                js: "/theme/Grace/source/js/jquery.lazyload.min.js"
            },
            toc: {
                js: "/theme/Grace/source/js/toc.js"
            },
            wayPoints: {
                js: "/theme/Grace/source/js/jquery.waypoints.min.js"
            }
        }
    };

    console.log("%c Theme." + APP.version + " v" + APP.version + " %c https://www.extlight.com/ ", "color: white; background: #e9546b; padding:5px 0;", "padding:4px;border:1px solid #e9546b;");
